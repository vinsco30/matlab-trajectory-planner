...
T2 = [R0, p_des(:,2); 0 0 0 1];
T3 = [R0, p_des(:,3); 0 0 0 1];
T4 = [R0, p_des(:,4); 0 0 0 1];
T5 = [R0, p_des(:,5); 0 0 0 1];
T6 = [R0, p_des(:,6); 0 0 0 1];

[Tl1, d_Tl1, dd_p1] = task_space_traj(0, t_seg(1), T1, T2);
[Tc, d_Tc, dd_pc] = task_space_circular(0,t_c, T2, T3, T4);
[Tl2,d_Tl2, dd_p2] = task_space_traj(0, t_seg(2), T5, T6);
